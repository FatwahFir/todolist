...
const ChecklistModelSchema = CollectionSchema(
  ...
  links: {
    r'items': LinkSchema(
      id: 6518316973504694134,
      name: r'items',
      target: r'ChecklistItemModel',
      single: false,
      linkName: r'checklist',
    )
  },
  embeddedSchemas: {},
...
void _checklistModelAttach(
  ...
  object.id = id;
  object.items
      .attach(col, col.isar.collection<ChecklistItemModel>(), r'items', id);
}
...
extension ChecklistModelQueryLinks
    on QueryBuilder<ChecklistModel, ChecklistModel, QFilterCondition> {
  QueryBuilder<ChecklistModel, ChecklistModel, QAfterFilterCondition> items(
...
extension ChecklistModelQuerySortBy
  ...
  QueryBuilder<ChecklistModel, ChecklistModel, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<ChecklistModel, ChecklistModel, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChecklistModelQuerySortThenBy
  ...
  QueryBuilder<ChecklistModel, ChecklistModel, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<ChecklistModel, ChecklistModel, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension ChecklistModelQueryWhereDistinct
  ...
  QueryBuilder<ChecklistModel, ChecklistModel, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChecklistModelQueryProperty
  ...
  QueryBuilder<ChecklistModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
